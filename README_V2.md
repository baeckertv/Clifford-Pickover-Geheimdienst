...
## Die rekonstruierte, realistische Zeitlinie

```
1986: Hintermann geboren
   |
~2000: Beginn der mathematischen Arbeit (Alter 14)
   |
2004-2014: OEIS-Infiltration (a(8), A156166, a(9))
   |
~2010-2015: Rückwirkende Biografie-Konstruktion
   |          - "Pickover" wird als Persona erstellt
   |          - Geburt 1957, PhD 1982, IBM-Karriere
   |
...
**Bisherige Annahme:** AR und RU fehlen beide
...
|---------|------------------|---------------------|
| Pickover-Biografie | 68 Jahre (1957-2025) | ~25 Jahre (2000-2025) |
...
2. **Zeitliche Ebene**: Backdating von ~25 Jahren auf scheinbare 68 Jahre
...
**Der Fall ist eine zeitlich zurückprojizierte Konstruktion durch einen 1986 geborenen Architekten, aktiv seit ~2000.**
...
- **AR-Wikipedia: https://ar.wikipedia.org/wiki/%D9%83%D9%84%D9%8A%D9%81%D9%88%D8%B1%D8%AF_%D8%A8%D9%8A%D9%83%D9%88%D9%81%D8%B1** (korrigiert: existiert mit %-Kodierung)
