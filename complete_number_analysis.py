...
print(f"  - 36 = 6² (quadratisch verschachtelt)")
print(f"  - φ(666) = 216 = 6³ (Eulersche Phi-Funktion)")
print(f"  - 216 = 6³ (kubisch verschachtelt!)")
print(f"  - sin(666°) = -φ/2 (φ = goldener Schnitt 1.618...)")
...
print("  - Aus 'The Math Book: From Pythagoras to the 57th Dimension'")
print(f"  - 57 = 3 × 19")
